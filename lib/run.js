...
function generateDiffs(tasks) {
    ...
    for (var i = 0; i < tasks.length; i += 2) {
        ...
        var resolve, reject;
        var diffPromise = new Promise(function(res, rej){ resolve=res; reject=rej });

        gm.compare(taskA.imgPath, tastB.imgPath, {
            file: diffPath,
            ...
            tastB.equality = equality;
            console.log('equality', taskB.equality);
            resolve();
        });
