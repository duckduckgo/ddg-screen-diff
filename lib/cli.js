var yargs = require("yargs"),
    ...
    COMMANDS = ["search", "path", "ia", "group", "build-group"],
...
exports.check = function () {
    ...
    argv = yargs
        ...
        .command("build-group", "Create screenshots against a group building script", function (yargs) {
            addDefaults(yargs);
            argv = yargs.options(SCREENSHOT_OPS)
                .usage("Usage: " + BIN_NAME + " build-group <group name> [<host|env> ...] [options]\n\n" + HOST_MESSAGE)
                .demand(2, "Please specify a group building script name.")
                .argv;
        })
        .argv;
